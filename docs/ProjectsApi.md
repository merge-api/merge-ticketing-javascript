...
> PaginatedProjectList projectsList(x_account_token, opts)
...
let apiInstance = new MergeTicketingApi.ProjectsApi();
...
apiInstance.projectsList(x_account_token, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Project projectsRetrieve(x_account_token, id, opts)
...
apiInstance.projectsRetrieve(x_account_token, id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PaginatedUserList projectsUsersList(x_account_token, id, opts)
...
apiInstance.projectsUsersList(x_account_token, id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
