# MergeTicketingApi.AttachmentsApi
...
> TicketingAttachmentResponse attachmentsCreate(x_account_token, ticketing_attachment_endpoint_request, opts)
...
let apiInstance = new MergeTicketingApi.AttachmentsApi();
let x_account_token = "x_account_token_example"; // String | Token identifying the end user.
let ticketing_attachment_endpoint_request = new MergeTicketingApi.TicketingAttachmentEndpointRequest(); // TicketingAttachmentEndpointRequest | 
let opts = {
  'is_debug_mode': true, // Boolean | Whether to include debug fields (such as log file links) in the response.
  'run_async': true // Boolean | Whether or not third-party updates should be run asynchronously.
};
apiInstance.attachmentsCreate(x_account_token, ticketing_attachment_endpoint_request, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> PaginatedAttachmentList attachmentsList(x_account_token, opts)
...
apiInstance.attachmentsList(x_account_token, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> MetaResponse attachmentsMetaPostRetrieve(x_account_token)
...
let apiInstance = new MergeTicketingApi.AttachmentsApi();
let x_account_token = "x_account_token_example"; // String | Token identifying the end user.
apiInstance.attachmentsMetaPostRetrieve(x_account_token, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Attachment attachmentsRetrieve(x_account_token, id, opts)
...
apiInstance.attachmentsRetrieve(x_account_token, id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
