...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.AccountDetails();
  });
  ...
  describe('AccountDetails', function() {
    it('should create an instance of AccountDetails', function() {
      ...
      //var instane = new MergeTicketingApi.AccountDetails();
      //expect(instance).to.be.a(MergeTicketingApi.AccountDetails);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeTicketingApi.AccountDetails();
