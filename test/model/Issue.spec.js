...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.Issue();
  });
  ...
  describe('Issue', function() {
    it('should create an instance of Issue', function() {
      ...
      //var instane = new MergeTicketingApi.Issue();
      //expect(instance).to.be.a(MergeTicketingApi.Issue);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeTicketingApi.Issue();
