...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instane = new MergeTicketingApi.Account();
      //expect(instance).to.be.a(MergeTicketingApi.Account);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeTicketingApi.Account();
