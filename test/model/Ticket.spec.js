...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.Ticket();
  });
  ...
  describe('Ticket', function() {
    it('should create an instance of Ticket', function() {
      ...
      //var instane = new MergeTicketingApi.Ticket();
      //expect(instance).to.be.a(MergeTicketingApi.Ticket);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeTicketingApi.Ticket();
