...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.Team();
  });
  ...
  describe('Team', function() {
    it('should create an instance of Team', function() {
      ...
      //var instane = new MergeTicketingApi.Team();
      //expect(instance).to.be.a(MergeTicketingApi.Team);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeTicketingApi.Team();
