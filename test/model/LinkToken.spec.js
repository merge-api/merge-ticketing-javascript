...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.LinkToken();
  });
  ...
  describe('LinkToken', function() {
    it('should create an instance of LinkToken', function() {
      // uncomment below and update the code to test LinkToken
      //var instane = new MergeTicketingApi.LinkToken();
      //expect(instance).to.be.a(MergeTicketingApi.LinkToken);
    });
    ...
    it('should have the property link_token (base name: "link_token")', function() {
      ...
      //var instance = new MergeTicketingApi.LinkToken();
