...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instane = new MergeTicketingApi.Tag();
      //expect(instance).to.be.a(MergeTicketingApi.Tag);
    });
    ...
    it('should have the property remote_id (base name: "remote_id")', function() {
      ...
      //var instance = new MergeTicketingApi.Tag();
