...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.AccountToken();
  });
  ...
  describe('AccountToken', function() {
    it('should create an instance of AccountToken', function() {
      // uncomment below and update the code to test AccountToken
      //var instane = new MergeTicketingApi.AccountToken();
      //expect(instance).to.be.a(MergeTicketingApi.AccountToken);
    });
    ...
    it('should have the property account_token (base name: "account_token")', function() {
      ...
      //var instance = new MergeTicketingApi.AccountToken();
