...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.WarningValidationProblem();
  });
  ...
  describe('WarningValidationProblem', function() {
    it('should create an instance of WarningValidationProblem', function() {
      ...
      //var instane = new MergeTicketingApi.WarningValidationProblem();
      //expect(instance).to.be.a(MergeTicketingApi.WarningValidationProblem);
    });

    it('should have the property source (base name: "source")', function() {
      // uncomment below and update the code to test the property source
      //var instance = new MergeTicketingApi.WarningValidationProblem();
