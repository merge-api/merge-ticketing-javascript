...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.DataPassthroughRequest();
  });
  ...
  describe('DataPassthroughRequest', function() {
    it('should create an instance of DataPassthroughRequest', function() {
      ...
      //var instane = new MergeTicketingApi.DataPassthroughRequest();
      //expect(instance).to.be.a(MergeTicketingApi.DataPassthroughRequest);
    });

    it('should have the property method (base name: "method")', function() {
      // uncomment below and update the code to test the property method
      //var instance = new MergeTicketingApi.DataPassthroughRequest();
