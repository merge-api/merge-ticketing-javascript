...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.AvailableActions();
  });
  ...
  describe('AvailableActions', function() {
    it('should create an instance of AvailableActions', function() {
      ...
      //var instane = new MergeTicketingApi.AvailableActions();
      //expect(instance).to.be.a(MergeTicketingApi.AvailableActions);
    });
    ...
    it('should have the property integration (base name: "integration")', function() {
      ...
      //var instance = new MergeTicketingApi.AvailableActions();
