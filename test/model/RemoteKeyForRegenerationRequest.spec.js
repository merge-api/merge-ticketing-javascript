...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.RemoteKeyForRegenerationRequest();
  });
  ...
  describe('RemoteKeyForRegenerationRequest', function() {
    it('should create an instance of RemoteKeyForRegenerationRequest', function() {
      ...
      //var instane = new MergeTicketingApi.RemoteKeyForRegenerationRequest();
      //expect(instance).to.be.a(MergeTicketingApi.RemoteKeyForRegenerationRequest);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MergeTicketingApi.RemoteKeyForRegenerationRequest();
