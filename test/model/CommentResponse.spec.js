...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.CommentResponse();
  });
  ...
  describe('CommentResponse', function() {
    it('should create an instance of CommentResponse', function() {
      ...
      //var instane = new MergeTicketingApi.CommentResponse();
      //expect(instance).to.be.a(MergeTicketingApi.CommentResponse);
    });

    it('should have the property model (base name: "model")', function() {
      // uncomment below and update the code to test the property model
      //var instance = new MergeTicketingApi.CommentResponse();
