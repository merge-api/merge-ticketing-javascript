...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.IssuesApi();
  });
  ...
  describe('IssuesApi', function() {
    ...
    describe('issuesRetrieve', function() {
      it('should call issuesRetrieve successfully', function(done) {
        //uncomment below and update the code to test issuesRetrieve
        //instance.issuesRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
