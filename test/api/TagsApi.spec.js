...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeTicketingApi.TagsApi();
  });
  ...
  describe('TagsApi', function() {
    ...
    describe('tagsRetrieve', function() {
      it('should call tagsRetrieve successfully', function(done) {
        //uncomment below and update the code to test tagsRetrieve
        //instance.tagsRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
